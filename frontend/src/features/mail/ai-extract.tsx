...
import { copyText, getSafeExternalUrl } from '@/lib/utils'
...
export function AiExtract({ metadata, compact = false }: { metadata?: string; compact?: boolean }) {
  ...
  const externalUrl = isLink ? getSafeExternalUrl(item.result) : null
