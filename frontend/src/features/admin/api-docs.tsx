...
export function ApiDocsPage() {
  ...
  return <section className="h-full overflow-auto">
    <header className="border-b border-border px-5 py-4"><h1 className="text-base font-semibold">{t('apiDocumentation')}</h1><p className="mt-1 text-sm text-muted-foreground">{t('apiDocumentationIntro')}</p></header>
