...
export function UserSettingsPage() {
  ...
  const [createOpen, setCreateOpen] = useState(false), [renameOpen, setRenameOpen] = useState(false), [listOpen, setListOpen] = useState(false)
