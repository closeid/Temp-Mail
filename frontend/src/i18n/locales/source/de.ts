export const deMessages = {
  ...
  "views.Admin.account": "Adressen",
  "views.Index.accountSettings": "Kontoeinstellungen",
  "views.Admin.account_settings": "Adressregeln",
  ...
  "views.Admin.account_create": "Adresse erstellen",
  "views.Admin.configuration": "Konfiguration",
  "views.admin.CreateAccount.creatNewEmail": "Neue E-Mail erstellen",
  "views.common.Login.getNewEmail": "Neue E-Mail erstellen",
  "views.common.Login.createEmailUnavailable": "Das Erstellen neuer E-Mail-Adressen ist derzeit nicht verfügbar.",
  ...
  "views.user.UserLogin.invalidEmail": "Bitte geben Sie eine gültige E-Mail-Adresse ein",
  ...
  "views.admin.UserSettings.enable": "Neue Benutzerregistrierung erlauben",
  ...
  "components.MailContentRenderer.noSubject": "Kein Betreff",
  "components.MailContentRenderer.receivedAt": "Empfangen am",
  "components.MailContentRenderer.recipient": "Empfänger",
  ...
  "views.admin.Account.itemCount": "Gesamt",
  ...
  "views.user.UserLogin.loginWithAddressCredential": "Mit E-Mail-Zugangsdaten anmelden",
  ...
  "views.user.UserLogin.registrationUnavailable": "Die Registrierung ist derzeit nicht verfügbar.",
  ...
  "components.MailContentRenderer.sender": "Absender",
