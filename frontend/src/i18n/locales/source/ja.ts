export const jaMessages = {
  ...
  "views.Admin.account": "アドレス",
  "views.Index.accountSettings": "アカウント設定",
  "views.Admin.account_settings": "アドレスルール",
  ...
  "views.Admin.account_create": "アドレスを作成",
  "views.Admin.configuration": "設定",
  "views.admin.CreateAccount.creatNewEmail": "新しいメールを作成",
  "views.common.Login.getNewEmail": "新しいメールを作成",
  "views.common.Login.createEmailUnavailable": "現在、新しいメールアドレスは作成できません。",
  ...
  "views.user.UserLogin.invalidEmail": "有効なメールアドレスを入力してください",
  ...
  "views.admin.UserSettings.enable": "新規ユーザー登録を許可",
  ...
  "components.MailContentRenderer.noSubject": "件名なし",
  "components.MailContentRenderer.receivedAt": "受信日時",
  "components.MailContentRenderer.recipient": "受信者",
  ...
  "views.admin.Account.itemCount": "合計",
  ...
  "views.user.UserLogin.loginWithAddressCredential": "メール認証情報でログイン",
  ...
  "views.user.UserLogin.registrationUnavailable": "現在、登録は利用できません。",
  ...
  "components.MailContentRenderer.sender": "送信者",
