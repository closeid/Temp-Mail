...
api.get('/api/admin/users/:user_id/passkeys', admin_user_api.getUserPasskeys)
api.delete('/api/admin/users/:user_id/passkeys/:passkey_id', admin_user_api.deleteUserPasskey)
